                  ...
                  {contacts.slice(0, 3).map((contact) => (
                    ...
                    >
                      <div className="flex-shrink-0">
                        <div className="w-8 h-8 min-w-[2rem] min-h-[2rem] aspect-square bg-[#12b5e5]/20 rounded-full flex items-center justify-center">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm truncate text-[#262522]">
